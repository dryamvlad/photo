...
$_lang['gallery.item_upload'] = 'Загрузить';
...
$_lang['gallery.multi_item_upload'] = 'Загрузить несколько';
$_lang['gallery.item_active_desc'] = 'Неактивные элементы не будут отображаться в альбомах.';
